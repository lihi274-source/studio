...
const StatusBadge = ({ status, t }: { status: string, t: any }) => {
  ...
  return (
    <span className={cn(
      'px-2.5 py-0.5 rounded-full text-xs font-semibold print:border print:bg-transparent',
...
export default function DocumentsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-2 border-primary/20 shadow-xl overflow-hidden no-print">
